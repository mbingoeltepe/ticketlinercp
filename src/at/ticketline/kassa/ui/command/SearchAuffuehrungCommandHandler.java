...
public class SearchAuffuehrungCommandHandler extends AbstractHandler implements
	IHandler {
    public static final String ID = "at.ticketline.kassa.ui.command.sucheAuffuehrung";
	...
	try {
		...
		page.showView(AuffuehrungSucheView.ID);
	    } else
		EasyMessage.showLoginRequiredMessage(ID);
	} catch (PartInitException e) {
	    MessageDialog.openError(window.getShell(), "Error",
		    "Suche Auffuehrung View konnte nicht geoeffnet werden: "
			    + e.getMessage());
	    this.log.error(e);
	}
	return null;
