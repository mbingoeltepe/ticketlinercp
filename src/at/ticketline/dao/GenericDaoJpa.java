...
public abstract class GenericDaoJpa<E, ID extends Serializable> implements
		GenericDao<E, ID> {
	...
	public GenericDaoJpa() {
		...
		this.removeAllString = "DELETE FROM " + this.entityClass.getSimpleName() + " e";
	}
	...
	public void removeAll(){
		EntityTransaction trans = this.entityManager.getTransaction();
		trans.begin();
		this.entityManager.createQuery(this.removeAllString).executeUpdate();
		trans.commit();
	}
